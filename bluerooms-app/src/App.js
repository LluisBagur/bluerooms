...
logic.url = 'https://sleepy-cliffs-48736.herokuapp.com/api' //poner en un .ENV, con la API KEY
...
class App extends Component {
    ...
    render() {
        ...
        return <div className="body">
            ...
            <Route exact path="/rental/:id" render={props => <RentalPage id={props.match.params.id} isLoggedIn={this.state.loggedIn} handleLoggedIn={this.handleLoggedIn}/>} />       
